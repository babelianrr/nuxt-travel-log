...
function searhResultSelected(result: NominatimResult) {
        ...
        <div class="flex flex-col gap-3">
            ...
            <form class="flex flex-col gap-2" @submit.prevent="onSubmit">
                ...
                <ul class="list-disc ml-5 text-sm">
                    ...
                    <li>Or double click on the map.</li>
                    <li>Or use search bar below.</li>
                </ul>
            ...
            <hr class="divider">
            <AppPlaceSearch @result-selected="searhResultSelected" />
        </div>
    </div>
</template>
