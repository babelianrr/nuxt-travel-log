...
const props = defineProps<{
    initialValues?: T;
    schema: ZodSchema;
    onSubmit: (location: T) => Promise<any> | void;
...
onMounted(() => {
    mapStore.addedPoint = {
        ...
        name: "Added Point",
        description: "",
        long: props.initialValues?.long || (CENTER_SGP as [number, number])[0],
        lat: props.initialValues?.lat || (CENTER_SGP as [number, number])[1],
        zoom: props.zoom,
    };
});
